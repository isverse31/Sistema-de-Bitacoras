    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <button class="Btn" href="javascript:void(0);" id="btnAbrirModalEditar_<?php echo $camara['id']; ?>"
                        onclick="abrirModalEditar(<?php echo $camara['id']; ?>)">Editar
                    ...
                    <a href="<?php echo site_url('camaras/eliminar/' . $camara['id']); ?>" class="button delete"
                        onclick="return confirm('¿Estás seguro de que quieres eliminar esta cámara?');">
    ...
    <div id="modalEditarCamara_<?php echo $camara['id']; ?>" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-column">
                    <label for="nombre">Nombre:</label>
                    <input type="text" name="nombre" value="<?php echo $camara['nombre']; ?>" required
